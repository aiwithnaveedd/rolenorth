...
const hasMultipleReports = reports && reports.length >= 2;
return (
  <div className="min-h-screen ">
    <div className="max-w-6xl mx-auto px-6 py-12">
      ...
      {/* Subscription Status - Kept as you had */}
      {/* (Add your subscription status component here if you have one) */}

      {/* Reports Section - Minimal Enhancement */}
      <div className="mb-8 flex justify-between items-center">
        <h2 className="text-3xl font-semibold">Your Reports</h2>
        ...
        {hasMultipleReports && (
          ...
          >
            Compare Reports <ArrowRight className="w-4 h-4" />
          </Link>
        )}
      </div>
